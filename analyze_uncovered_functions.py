...
def categorize_functions(functions):
    ...
    patterns = {
        'CLI/Main': ['main', 'run', 'show_unknown_routes', 'record_race_result', 
                     'handle_', 'parse_args', 'cli_'],
        'Network/API': ['fetch_', 'api_', 'request_', 'http_', 'get_events', 
                        'fetch_events', 'fetch_zwiftpower_stats'],
        'Business Logic': ['filter_', 'calculate_', 'estimate_', 'process_', 
                           'analyze_', 'determine_', 'compute_', 'validate_'],
        'Database': ['db_', 'query_', 'insert_', 'update_', 'delete_', 'get_route_data',
                     'store_', 'load_from_db', 'save_to_db'],
...
def main():
    ...
    known_uncovered = [
        'main', 'show_unknown_routes', 'record_race_result',
        'fetch_events', 'fetch_zwiftpower_stats', 
        'filter_events', 'estimate_duration_with_distance',
        'display_events', 'get_route_data', 'process_multi_lap_event',
        'handle_api_error', 'parse_event_tags', 'format_table_output',
        'check_token_expiry', 'refresh_auth_token', 'validate_filters',
        'calculate_drop_probability', 'get_rider_weight', 'apply_elevation_penalty'
    ]
