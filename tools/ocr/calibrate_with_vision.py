...
def create_config_file(regions: Dict, image_path: str, output_path: str) -> None:
    ...
    print("2. Test with: python visual_region_mapper.py {} --config {}".format(
...
def main():
    ...
    parser.add_argument("--provider", choices=["groq", "huggingface", "together", "ollama"], 
                      default="groq", help="Vision API provider (default: groq)")
    parser.add_argument("--output", default="ocr_regions_draft.json",
