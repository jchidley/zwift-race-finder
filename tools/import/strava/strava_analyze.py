...
def load_activities(filepath: str = "strava_zwift_activities.json") -> List[Dict[str, Any]]:
...
def is_race(name: str) -> bool:
    ...
    exclude_keywords = ['group ride', 'easy', 'recovery', 'endurance', 'zone 2', 'meetup', 'workout']
...
def update_database_with_insights(db_path: str, activities: List[Dict[str, Any]]) -> None:
    ...
    if races:
        ...
        print(f"   This includes draft benefit in races")
        print(f"   Use this to calibrate speed estimates!")
